...
/**
 * LocalizadosSearch represents the model behind the search form of `app\models\NoLocalizados`.
 */
class LocalizadosSearch extends NoLocalizados
{
    /**
     * {@inheritdoc}
     */
